...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    home.file = {
      # Hyprlock configs
      ".config/hypr/hyprlock.conf" = lib.mkIf cfg.hyprlock (lib.mkDefault {
        source = "${pkgs.hydenix.hyde}/Configs/.config/hypr/hyprlock.conf";
      });
      ".config/hypr/hyprlock/Anurati.conf" = lib.mkIf cfg.hyprlock (lib.mkDefault {
        source = "${pkgs.hydenix.hyde}/Configs/.config/hypr/hyprlock/Anurati.conf";
      });
      ".config/hypr/hyprlock/Arfan on Clouds.conf" = lib.mkIf cfg.hyprlock (lib.mkDefault {
        source = "${pkgs.hydenix.hyde}/Configs/.config/hypr/hyprlock/Arfan on Clouds.conf";
      });
      ".config/hypr/hyprlock/IBM Plex.conf" = lib.mkIf cfg.hyprlock (lib.mkDefault {
        source = "${pkgs.hydenix.hyde}/Configs/.config/hypr/hyprlock/IBM Plex.conf";
      });
      ".config/hypr/hyprlock/SF Pro.conf" = lib.mkIf cfg.hyprlock (lib.mkDefault {
        source = "${pkgs.hydenix.hyde}/Configs/.config/hypr/hyprlock/SF Pro.conf";
      });
      ".config/hypr/hyprlock/theme.conf" = lib.mkIf cfg.hyprlock (lib.mkDefault {
        source = "${pkgs.hydenix.hyde}/Configs/.config/hypr/hyprlock/theme.conf";
      });

      # Swaylock config
      ".config/swaylock/config" = lib.mkIf cfg.swaylock (lib.mkDefault {
