...
let
  ...
  fontDerivations = [
    ...
    (mkFontDerivation {
      name = "jetbrains-mono";
      url = "https://github.com/HyDE-Project/HyDE/raw/${commit}/Source/arcs/Font_JetBrainsMono.tar.gz";
      sha256 = "sha256-+oOEGwkgFq44Efm+ER0y7MtFbMlSP2oISJpwINT/s3o=";
    })
    (mkFontDerivation {
      name = "maple";
      url = "https://github.com/HyDE-Project/HyDE/raw/${commit}/Source/arcs/Font_MapleNerd.tar.gz";
      sha256 = "sha256-3bshil2SQthUgM8+lSvNebSLvCxxW9CZvxAYvg2bVmg=";
    })
    (mkFontDerivation {
      name = "material-design-icons";
      url = "https://github.com/HyDE-Project/HyDE/raw/${commit}/Source/arcs/Font_MaterialDesign.tar.gz";
      sha256 = "sha256-OEfQJOou3uAQVLMS5xiUDqt4XJfNWSGL8lxuSdlUVVE=";
    })
    (mkFontDerivation {
      name = "mononoki";
      url = "https://github.com/HyDE-Project/HyDE/raw/${commit}/Source/arcs/Font_MononokiNerd.tar.gz";
      sha256 = "sha256-TCXjopJEDNg8YtYoCMIqs1M43Yj8c+LKBc8RLMFaV58=";
    })
    (mkFontDerivation {
      name = "noto-sans-cjk";
      url = "https://github.com/HyDE-Project/HyDE/raw/${commit}/Source/arcs/Font_NotoSansCJK.tar.gz";
