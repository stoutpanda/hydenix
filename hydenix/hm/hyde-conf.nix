...
''
  ...
  hydeTheme="${userConfig.hyde.conf.hydeTheme or "Catppuccin Mocha"}"
  ...
  wallFramerate=${toString (userConfig.hyde.conf.wallFramerate or 144)}

  #// wallTransDuration sets the transition duration while changing wallpaper
  #// set this value in seconds
  wallTransDuration=${toString (userConfig.hyde.conf.wallTransDuration or 0.4)}
  ...
  wallAddCustomPath="${userConfig.hyde.conf.wallAddCustomPath or ""}"
  ...
  enableWallDcol="${toString (userConfig.hyde.conf.enableWallDcol or 2)}"
  ...
  wallbashCustomCurve="${userConfig.hyde.conf.wallbashCustomCurve or ""}"
  ...
  #// available styles - 1 (default) , 2
  wlogoutStyle=${toString (userConfig.hyde.conf.wlogoutStyle or 1)}
''
